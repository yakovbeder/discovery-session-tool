...
<body>
  ...
  <div class="header">
    <div class="header-left">
      ...
      <div>
        <h1>OpenShift Discovery Session</h1>
        <div class="header-subtitle">Deployment Planning Checklist</div>
      </div>
    </div>
  ...
  <!-- Footer -->
  <div class="footer">
    Red Hat OpenShift Discovery Session Checklist &mdash; Confidential
  </div>
